...
def create_seizure_dataset(length, sf):
    """ return sessions with seizures.
    :param length: The length of each segments to feed into the VAE model
    :param sf: The sampling frequency of the EEG data
